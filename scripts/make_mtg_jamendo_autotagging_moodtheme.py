...
if __name__ == '__main__':
    PARSER = argparse.ArgumentParser(description='Make mtg_jamendo_autotagging_moodtheme index file.')
    PARSER.add_argument('mtg_jamendo_autotagging_moodtheme_data_path', type=str, help='Path to mtg_jamendo_autotagging_moodtheme data folder.')
