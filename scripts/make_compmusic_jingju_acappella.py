...
JINJGU_ACAPPELLA_INDEX_PATH = (
    "../mirdata/datasets/indexes/compmusic_jingju_acappella_index.json"
)
                    ...
                    for song in os.listdir(
                        ...
                        if ".DS" not in song:
                            ...
                            jingju_index["tracks"][index]["audio"] = (
                                ...
                                md5(
                                    os.path.join(
                                        dataset_data_path, folder, folder_, song
                                    )
                                ),
                            )
                    ...
                    for file in os.listdir(
                        ...
                        if "phoneme" in file:
                            ...
                            jingju_index["tracks"][index]["phoneme"] = (
                                ...
                                md5(
                                    os.path.join(
                                        dataset_data_path, folder, folder_, file
                                    )
                                ),
                            )
...
if __name__ == "__main__":
    PARSER = argparse.ArgumentParser(
        description="Make CompMusic Jingju A Cappella index file."
    )
    PARSER.add_argument(
        "dataset_data_path",
        type=str,
