...
def _index(egset12_data_path: str, version: str) -> None:
    # paths to files
...
def main(args):
    _index(args.egset12_data_path, args.version)


if __name__ == "__main__":
    PARSER = argparse.ArgumentParser(description="Make egset12 index file.")
    PARSER.add_argument(
        "egset12_data_path", type=str, help="path to egset12 data folder."
    )
