...
SIMAC_RHYTHM_INDEX_PATH = "../mirdata/datasets/indexes/simac_full_index_1.0.json"

def make_simac_rhythm_index(dataset_data_path):
    cmr_index = {
        "version": "1.0",
        "tracks": {},
    }
    
    dataset_folder_name = "S_1.0"  # Update this folder name if needed
    ...
    with open(SIMAC_RHYTHM_INDEX_PATH, "w") as fhandle:
        json.dump(cmr_index, fhandle, indent=2)

def main(args):
    print("creating index...")
    make_simac_rhythm_index(args.dataset_data_path)
    print("done!")

if __name__ == "__main__":
    PARSER = argparse.ArgumentParser(description="Make simac Rhythm index file.")
    PARSER.add_argument(
        "dataset_data_path", type=str, help="Path to simac Rhythm data folder."
    )
