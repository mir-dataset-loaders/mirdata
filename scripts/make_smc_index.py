...
SMC_RHYTHM_INDEX_PATH = "../mirdata/datasets/indexes/smc_full_index_1.0.json"

def make_smc_rhythm_index(dataset_data_path):
    cmr_index = {
        "version": "1.0",
        "tracks": {},
    }
    ...
    with open(SMC_RHYTHM_INDEX_PATH, "w") as fhandle:
        json.dump(cmr_index, fhandle, indent=2)

def main(args):
    print("creating index...")
    make_smc_rhythm_index(args.dataset_data_path)
    print("done!")

if __name__ == "__main__":
    PARSER = argparse.ArgumentParser(description="Make smc Rhythm index file.")
    PARSER.add_argument(
        "dataset_data_path", type=str, help="Path to smc Rhythm data folder."
    )
