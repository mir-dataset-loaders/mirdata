...
def make_haydn_op20_index(data_path):
    movements = [os.path.join(data_path, 'op20n' + str(number) + '-0' + str(movement))
                 for number in range(1, 7) for movement in range(1, 5)]
    haydn_op20_tracks = {}
...
if __name__ == '__main__':
    ...
    PARSER.add_argument(
        'haydn_op20_data_path', type=str, help='Path to haydn op20 data folder.'
    )
