...
def make_dataset_index(data_path):
    ...
    families = {'doublebass':'strings','cello':'strings','clarinet':'woodwinds',
    ...
    for ip,piece in enumerate(pieces):
        ...
        for instrument in set_instruments:
            assert instrument in families.keys(),"instrument {} is not in the list of dataset instruments".format(instrument)
        ...
        for instrument in set_instruments:
            ...
            for i,audio_file in enumerate(instrument_audio_files):
                ...
                index[piece]['audio-'+source] = ('audio/{}/{}'.format(piece,os.path.basename(audio_file)), audio_checksum)
