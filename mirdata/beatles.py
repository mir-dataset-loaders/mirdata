...
class Track(object):
    ...
    def __repr__(self):
        repr_string = "Beatles Track(track_id={}, audio_path={}, title={}, beats=BeatData('beats_times, 'beats_positions'), chords=ChordData('start_times', 'end_times', 'chords'), key=KeyData('start_times', 'end_times', 'keys'), sections=SectionData('start_times', 'end_times', 'sections'))"
