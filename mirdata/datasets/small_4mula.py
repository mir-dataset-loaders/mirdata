...
.. admonition:: Dataset Info
    ...
    The dataset consists of 9661 musics represents by melspectrogram and metadata. It
    contains 51 genres and 491 artists. The audio file is not available. All attributes are:
...
def load_by_columns(fhandle: str, columns: list = DEFAULT_COLUMNS):
    """Load a small_4mula dataset filtering by columns.
    ...
    Returns:
        pandas.DataFrame: small_4mula dataset filtered by columns
