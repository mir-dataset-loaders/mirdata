...
BIBTEX = """
    @inproceedings{
        ...
        author = {Wong, Stella and Hernandez, Gandalf, Baptiste Campeas},
...
INDEXES = {
    "default": "1.0",
    "test": "1.0",
    "1.0": core.Index(filename="fmakv2_index_1.0.json"),
}
...
REMOTES = {
    "metadata": download_utils.RemoteFileMetadata(
        ...
        destination_dir='../../../dataset/metadata'
    ),
    "tracks-000-019": download_utils.RemoteFileMetadata(
        ...
        destination_dir='../../../dataset/archives'
    ),
