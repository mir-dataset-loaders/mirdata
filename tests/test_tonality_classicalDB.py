...
def test_track():
    ...
    expected_attributes = {
        ...
        "mb_path": "tests/resources/mir_datasets/tonality_classicalDB/musicbrainz_metadata/01-Allegro__Gloria_in_excelsis_Deo_in_D_Major - D.json",
...
def test_load_mb_metadata():
    ...
    mb_metadata_data = tonality_classicalDB.load_mb(mb_metadata_path)
    print(mb_metadata_data)
    assert type(mb_metadata_data) == dict
    assert mb_metadata_data == mb_metadata_annotated

    assert tonality_classicalDB.load_mb(None) is None
