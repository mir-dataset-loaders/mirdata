...
def test_track():
    ...
    expected_attributes = {
        ...
        "f0_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/tonas/"),"Deblas/01-D_AMairena.f0.Corrected"),
        "notes_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/tonas/"),"Deblas/01-D_AMairena.notes.Corrected"),
        "audio_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/tonas/"),"Deblas/01-D_AMairena.wav"),
