...
def test_track():
    ...
    expected_attributes = {
        "track_id": "lseh-Tan_Yang_jia-Hong_yang_dong-qm",
        "audio_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/compmusic_jingju_acappella/")
        , "wav/laosheng/lseh-Tan_Yang_jia-Hong_yang_dong-qm.wav"),
        "phrase_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/compmusic_jingju_acappella/")
        , "annotation_txt/laosheng/lseh-Tan_Yang_jia-Hong_yang_dong-qm_phrase.txt"),
        "phrase_char_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/compmusic_jingju_acappella/")
        , "annotation_txt/laosheng/lseh-Tan_Yang_jia-Hong_yang_dong-qm_phrase_char.txt"),
        "phoneme_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/compmusic_jingju_acappella/")
        , "annotation_txt/laosheng/lseh-Tan_Yang_jia-Hong_yang_dong-qm_phoneme.txt"),
        "syllable_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/compmusic_jingju_acappella/")
        ...
        "textgrid_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/compmusic_jingju_acappella/")
