...
def test_track():
    ...
    expected_attributes = {
        "audio_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/giantsteps_tempo/"),"audio/28952.LOFI.mp3"),
        "annotation_v1_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/giantsteps_tempo/")
        ,"giantsteps-tempo-dataset-0b7d47ba8cae59d3535a02e3db69e2cf6d0af5bb/annotations/jams/28952.LOFI.jams"),
        "annotation_v2_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/giantsteps_tempo/")
