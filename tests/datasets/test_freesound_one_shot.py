...
def test_track():
    ...
    expected_attributes = {
        "audio_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/freesound_one_shot_percussive_sounds/")
        , "one_shot_percussive_sounds/1/183.wav"),
        "file_metadata_path": os.path.join(os.path.normpath("tests/resources/mir_datasets/freesound_one_shot_percussive_sounds/")
