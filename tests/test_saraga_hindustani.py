...
def test_load_pitch():
    ...
    assert np.array_equal(
        parsed_pitch.times, np.array([0.0, 0.0044444444444444444, 0.008888888888888889, 0.013333333333333334,
                                      0.017777777777777778, 0.022222222222222223])
    )
    assert np.array_equal(
        parsed_pitch.frequencies, np.array([0., 11.111111111111111111, 222.22222222222222222, 333.333333333333333333,
                                            444.444444444444444444, 0.])
    )
    assert np.array_equal(
...
def test_load_sections():
    ...
    assert np.array_equal(
        parsed_sections.intervals[:, 1], np.array([59.49, 679.8340000000001, 898.664489796])
    )
    assert parsed_sections.labels == ['Ālāp-1', 'Khyāl (vilambit ēktāl)-2', 'Khyāl (dr̥t ēktāl)-3']
...
def test_load_phrases():
    ...
    # Check values
    assert np.array_equal(
        parsed_phrases.start_times, np.array([3.506213151, 12.538775510, 23.382494331])
    )
    assert np.array_equal(
        parsed_phrases.end_times, np.array([10.890158729, 18.924263038, 32.252517006])
    )
...
def test_load_metadata():
    ...
    assert parsed_metadata['data_home'] == 'tests/resources/mir_datasets/saraga_hindustani'
