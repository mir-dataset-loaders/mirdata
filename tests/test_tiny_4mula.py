...
def test_track():
    ...
    expected_attributes = {
        ...
        'related_genre': ['Romântico', 'Samba', 'Pagode', 'Axé', 'MPB', 'Regional', 'House', 'Hardcore', 'Sertanejo',
                          'Indie', 'Electronica', 'Bossa Nova', 'Pop', 'K-Pop/K-Rock', 'Infantil', 'Trilha Sonora',
                          'Black Music', 'Jovem Guarda', 'Clássico', 'Samba Enredo', 'Dance', 'Forró'],
        'related_music': [{'id': '3ade68b3gcc86eda3', 'name': 'Que Se Chama Amor', 'lang': 'pt-br'},
                          ...
                          {'id': '3ade68b8gffebdfa3', 'name': 'Balada Boa (Tchê Tchê Rere)', 'lang': 'pt-br'},
