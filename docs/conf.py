...
extlinks = {
    "acousticbrainz": ("https://zenodo.org/record/2554044#.X_ivJ-n7RUI", "Custom"),
    "cante": ("https://zenodo.org/record/1324183#.X_nq7-n7RUI", "Custom"),
    "ikala": ("http://mac.citi.sinica.edu.tw/ikala/", "Custom"),
    "rwc": ("https://staff.aist.go.jp/m.goto/RWC-MDB/", "Custom"),
    "tonas": ("https://www.upf.edu/web/mtg/tonas/", "Custom"),
}
